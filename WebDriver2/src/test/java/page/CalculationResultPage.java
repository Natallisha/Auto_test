...
public class CalculationResultPage extends AbstractPage {
    ...
    private final By RESULT_FIELDS_LOCATOR = By.xpath("//md-card-content[@id = 'resultBlock']//md-list-item/div");
    ...
    public String getValueOfItem(String itemName) {
        ...
        List<WebElement> listOfResultItem = driver.findElements(RESULT_FIELDS_LOCATOR);
